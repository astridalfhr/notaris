                        ...
                        <?php if (!empty($rows)):
                            ...
                            foreach ($rows as $u): ?>
                                ...
                                <tr>
                                    <td><?= $i++ ?></td>
                                    <td>
                                        <div style="font-weight:600;"><?= esc($u['display_name'] ?? ($u['u_nama'] ?? '-')) ?>
                                        </div>
                                        <div class="muted" style="font-size:12px;">ID: <?= (int) $u['id'] ?></div>
                                    </td>
                                    <td><?= esc($u['email'] ?? '-') ?></td>
                                    <td><span class="badge <?= esc($curr) ?>"><?= esc(ucfirst($u['role'] ?? 'User')) ?></span>
                                    </td>
                                    <td>
                            ...
                            <?php endforeach; else: ?>
                            <tr>
                                <td colspan="6" class="muted" style="text-align:center;">Belum ada pengguna ditemukan.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
