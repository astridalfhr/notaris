                        ...
                        <tr>
                            <td style="white-space:nowrap;">
                                <form action="<?= site_url('multiuser/hero/move-up/' . $r['id']) ?>" method="post"
                                    style="display:inline"><?= csrf_field() ?><button class="btn small">▲</button></form>
                            ...
                            <td style="white-space:nowrap;">
                                <a class="btn small warn" href="<?= site_url('multiuser/hero/edit/' . $r['id']) ?>">Edit</a>
                                <form action="<?= site_url('multiuser/hero/toggle/' . $r['id']) ?>" method="post"
                                    style="display:inline"><?= csrf_field() ?><button
                                        class="btn small"><?= $r['is_active'] ? 'Nonaktifkan' : 'Aktifkan' ?></button></form>
