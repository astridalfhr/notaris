...
<div class="admin-layout">
    ...
    <main class="admin-main">
        <div class="admin-head">
            ...
            <a class="btn-grad" href="<?= site_url('admin/kerja') ?>"><i class="fa-solid fa-list"></i> Rekap</a>
        </div>

        <p class="muted" style="margin-bottom:16px;"><?= esc($desc) ?></p>

        <form action="<?= site_url('admin/kerja/upload') ?>" method="post" enctype="multipart/form-data" class="card">
            <?= csrf_field() ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row-actions">
                                        ...
                                        <form action="<?= site_url('admin/kerja/delete') ?>" method="post"
